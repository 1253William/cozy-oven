...
export const operationsService = {
  ...
  supplyStock: async () => (await apiClient.get("/api/v1/dashboard/admin/operations/supply-stock")).data,
  movements: async () => (await apiClient.get("/api/v1/dashboard/admin/operations/movements")).data,
  supplyMovements: async () => (await apiClient.get("/api/v1/dashboard/admin/operations/supply-movements")).data,
  ...
  supplyOpeningBalance: async (data: Record<string, unknown>) => (await apiClient.post("/api/v1/dashboard/admin/operations/supply-opening-balance", data)).data,
