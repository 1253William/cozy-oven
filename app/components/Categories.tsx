...
export default function Categories() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen font-[Euclid-Circular-B] mt-12">
      <div className="w-full max-w-7xl px-4 py-8">
        ...
        >
          {currentCards.map((card) => (
            <motion.div
              ...
              className="relative overflow-hidden rounded-4xl text-white h-[500px] group"
            >
              <div
                className="absolute inset-0 bg-cover bg-center transition-transform duration-500 ease-in-out group-hover:scale-110 z-0"
                style={{ backgroundImage: `url(${card.bgImage})` }}
              ...
              <div className="relative z-20 p-8 h-full flex flex-col">
                ...
                <div className="mb-4 opacity-0 translate-y-4 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
                  <button className={`font-medium py-3 px-7 rounded-full bg-black shadow-sm hover:cursor-pointer`}>
                    {card.button}
                  </button>
                </div>
              </div>
